...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :goto_0
    #setter for: Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;->mWifiP2pEnabled:Z
    invoke-static {v5, v3}, Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;->access$002(Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;Z)Z
    ...
    #calls: Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;->handleP2pStateChanged()V
    invoke-static {v3}, Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;->access$100(Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;)V
    ...
    invoke-static {v3}, Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;->access$200(Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;)Landroid/net/wifi/p2p/WifiP2pManager;
    ...
    #calls: Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;->startSearch()V
    invoke-static {v3}, Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;->access$400(Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;)V
    ...
    #setter for: Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;->mThisDevice:Landroid/net/wifi/p2p/WifiP2pDevice;
    invoke-static {v4, v3}, Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;->access$502(Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;Landroid/net/wifi/p2p/WifiP2pDevice;)Landroid/net/wifi/p2p/WifiP2pDevice;

    .line 127
    iget-object v3, p0, Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings$1;->this$0:Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;

    #calls: Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;->updateDevicePref()V
    invoke-static {v3}, Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;->access$600(Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;)V
    ...
    #calls: Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;->updateSearchMenu(Z)V
    invoke-static {v4, v3}, Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;->access$700(Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;Z)V
    ...
    #calls: Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;->updateSearchMenu(Z)V
    invoke-static {v3, v4}, Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;->access$700(Lcom/android/OriginalSettings/wifi/p2p/WifiP2pSettings;Z)V
